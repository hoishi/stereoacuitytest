...
title(type);
saveName = ['Result_session1234', '_',data(n).subjectID, '_',data(1).type, '_', data(1).id, '_','.fig'];
saveName_png = ['Result_session1234', '_',data(n).subjectID, '_',data(1).type, '_', data(1).id, '_','.png'];
